...
const updateUI = (data) => {
    ...
    // update day/night img and icons
...
// makes the api calls from forecast.js
...
cityForm.addEventListener('submit', e => {
    //prevent default event (submits default is refreshing the page)
    e.preventDefault();
    //get city value - trim() removes white space 
